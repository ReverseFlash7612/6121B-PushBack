...
ez::Drive chassis(
    ...
    {7, 19, 15},  // Right Chassis Ports (negative port will reverse it!)
...
ez::tracking_wheel horiz_tracker(12, 2.75, 0.5);  // This tracking wheel is perpendicular to the drive wheels
