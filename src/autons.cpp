...
void blueNegative() {
  ...
  chassis.pid_wait();
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  chassis.pid_turn_set(-71.5_deg, TURN_SPEED, true);
  chassis.pid_wait();
  setIntake(false);
  ...
  nextState();
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  chassis.pid_odom_set({{-7_in, -10_in}, fwd, 110});
  chassis.pid_wait();
...
void redPositive() {
  ...
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  pros::delay(100);
  chassis.pid_turn_set(171_deg, TURN_SPEED, true);
  chassis.pid_wait();
  ...
  setStakeTarget(145);
  //chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  //chassis.pid_swing_set(ez::LEFT_SWING, 35_deg, SWING_SPEED, 37);
  //chassis.pid_wait();
  pros::delay(300);
...
void redNegative() {
  ...
  chassis.pid_wait();
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  chassis.pid_turn_set(-56.5_deg, TURN_SPEED, true);
  chassis.pid_wait();
  chassis.pid_drive_set(13.5_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  pros::delay(75);
  chassis.pid_drive_set(-4.5_in, DRIVE_SPEED, false);
  chassis.pid_wait();
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  chassis.pid_turn_set(69.5_deg, TURN_SPEED, true);
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  chassis.pid_turn_set(162.5_deg, TURN_SPEED, true);
  chassis.pid_wait();
...
void bluePositive() {
  ...
  chassis.odom_xyt_set(0_in, 0_in, 0_deg);
  pros::delay(250);
  chassis.pid_turn_set(-173_deg, TURN_SPEED, true);
  chassis.pid_wait();
  setStack(true);
